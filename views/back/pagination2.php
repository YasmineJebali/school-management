...
require_once '../../controller/configg.php';
    ...
    {       $total=0;
        ...
        $output .='
            <tr>
                ...
                <td>
                  <a href="displayProduct.php?id_prod=' .$row["id_prod"]. '"> Supprimer </a> 
                </td>
            </tr>
        ';
        $total+=1;
    ...
    $page_query = "SELECT * from produit inner join categorie on 
    id_categorie=categorie.id ORDER BY id_prod DESC";
